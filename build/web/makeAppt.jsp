<%-- Document : FA_appointment Created on : 6 Jun 2022, 11:25:36 am Author : Acer --%>
    ...
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        ...
        <body class="d-flex h-100 text-center text-white bg-dark">
            <% String err=(String)request.getAttribute("errorMsg"); String
                alrt=(String)request.getAttribute("alertMsg"); %>
                        ...
                        <table class="table table-dark table-borderless">
                            <form action="makeAppt" method="POST">
                                <tr>
                                    ...
                                    <td><input type="name" id="username" name="username"
                                            placeholder="Enter your username" style="width:250px" autofocus required>
                                    </td>
                                </tr>
                                <tr>
                                    <td><label for="name">Enter your name:</label></td>
                                    <td><input type="name" id="name" name="name"
                                            placeholder="E.g. Mohammad Ali bin Akal" style="width:250px" required></td>
                                </tr>
