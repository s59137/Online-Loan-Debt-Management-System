                    ...
                    <form action="updateServ" method="post">
                        <table class="table table-dark table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="password" value="<%=password%>" placeholder="">
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="birthdate" value="<%=birthdate%>" placeholder="">
                                </td>
                            </tr><!-- comment -->
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="phonenumber" value="<%=phonenumber%>" placeholder="">
                                </td>
                            </tr>
